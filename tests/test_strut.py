...
class Test_Strut(unittest.TestCase):
    ...
    def test_constraint_strut(self):
        node1 = Node([0,0])
        node2 = Node([1,0])
        node3 = Node([2,0])
        ...
        self.assertGreaterEqual(np.matmul(constraint,vel),0)
        ...
        self.assertLessEqual(np.matmul(constraint,vel),0)

    def test_constraint_cable(self):
        node1 = Node([0,0])
        node2 = Node([1,0])
        node3 = Node([2,0])
    ...
    def test_constraint_string_cable(self):
        node1 = Node([0,0])
        node2 = Node([1,0])
        node3 = Node([2,0])
    ...
    def test_constraint_string_strut(self):
        node1 = Node([0,0])
        node2 = Node([1,0])
        node3 = Node([2,0])
